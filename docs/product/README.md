...
- [privacy-v4.html](./privacy-v4.html) — исходник публикуемого снимка политики `privacy-v4`, на который ссылается `PRIVACY_POLICY_V4_URL` и текст согласия. Под уже принятой версией текст не меняется: изменение границ обработки означает новую версию и повторное согласие.
