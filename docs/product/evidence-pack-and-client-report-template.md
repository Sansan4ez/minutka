...
```json
{
  ...
  "coverage": {
    ...
    "limitations": [
      "Роль тендеры представлена одним участником; её повторяющиеся операции — самоотчёт одного человека, не оценка",
      "Роль бухгалтерия представлена одним участником; её повторяющиеся операции — самоотчёт одного человека, не оценка",
      "Роль директор представлена одним участником; её повторяющиеся операции — самоотчёт одного человека, не оценка",
      "Часть времени не удалось связать с записями справочника повторяющихся операций: сотрудник описал работу, но она не совпала ни с одной проверенной операцией (разовые задачи, работа вне справочника, нераспознанные формулировки). Это время показано остатком «Другое / не удалось классифицировать» и по предметным категориям не распределено"
    ]
  },
  "timeBudget": [
  ...
  "cannotConclude": [
    ...
    "Ограничение покрытия: Часть времени не удалось связать с записями справочника повторяющихся операций: сотрудник описал работу, но она не совпала ни с одной проверенной операцией (разовые задачи, работа вне справочника, нераспознанные формулировки). Это время показано остатком «Другое / не удалось классифицировать» и по предметным категориям не распределено",
...
```markdown
# Карта повторяющихся операций и быстрых улучшений: <company>
