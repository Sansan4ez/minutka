...
5. Подтвердить consent и отправить естественный ответ, например: `Я руководитель проектов. Мои задачи: планирование, встречи и координация подрядчиков. Предпочитаю эффективность, с ИИ немного работал.` Затем проверить, что бот показывает summary и сохраняет профиль только после `✅ Подтвердить`.
