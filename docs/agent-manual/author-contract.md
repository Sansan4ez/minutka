...
- Do not copy common privacy and product-boundary rules into every process. Link to `docs/agent-manual/core.md` and `docs/agent-manual/processes/consent_and_privacy.md` instead.
