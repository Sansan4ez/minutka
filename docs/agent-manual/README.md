...
- The manual is loaded once by the application/spec harness and then used by the context resolver. It must not be read from disk on every chat request.
...
- `processes/index.md` — human-readable process catalogue and boundaries.
