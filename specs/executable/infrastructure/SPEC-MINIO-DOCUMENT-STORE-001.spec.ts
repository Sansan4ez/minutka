...
describe("SPEC-MINIO-DOCUMENT-STORE-001: atomic context creation and metadata listing", () => {
  ...
  it("supports optimistic update, move, delete and selected-version restore", async () => {
    ...
    const readsBeforeUpdate = client.getObjectCalls();
    ...
    expect(client.getObjectCalls() - readsBeforeUpdate).toBe(1);
    ...
    const readsBeforeDelete = client.getObjectCalls();
    ...
    expect(client.getObjectCalls() - readsBeforeDelete).toBe(1);
