...
Действует [docs/architecture/rfc-pilot-quality-bar.md](docs/architecture/rfc-pilot-quality-bar.md): контур пилота — 3–5 доверенных тестировщиков, single-owner, данные владельца не враждебны. Обязательно для всех агентов (разработка и ревью):
