-- Keep report preflight decisions and client-report publication outcomes as
-- content-free, scope-bound audit records. Report DTOs and finding text remain
-- outside the durable audit stream.
