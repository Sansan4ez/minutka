...
export const defaultContextBudget: ContextBudgetConfig = {
  ...
  sources: [
    ...
    { id: "agent_manual", priority: 2, ceiling: 29_000 },
...
const documentToolEnv = {
  ...
  maximumDocumentBytes: "ASSISTANT_DOCUMENT_MAXIMUM_BYTES",
  turnScanBytes: "ASSISTANT_DOCUMENT_TURN_SCAN_BYTES",
