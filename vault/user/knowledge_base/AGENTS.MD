...
- `10_user_memory`: user context, priority, goals, bussiness products, tags
- `20_work/`: contacts, reminders and active tasks
- `30_knowledge/`: capture, cards, ideas, notes, and threads
...
- `90_memory/`: assistant soul, memory and story/history surfaces
