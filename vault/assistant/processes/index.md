...
Except in `final_report`, across applicable processes at any time of day, explicitly reported completed or in-progress work is collected in one `collectActivities` batch; plans, intentions, future tasks, and not-started work are never collected.
