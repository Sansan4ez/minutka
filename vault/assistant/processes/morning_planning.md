...
5. Only after the employee explicitly names yesterday's factual completed or in-progress activities, call `collectActivities` once with one array item per named activity. Never record planned or not-started work. Omit unknown closed fields and never pass free text.
