...
5. For explicit completed or in-progress facts from yesterday's catch-up or today, send one `collectActivities` item per fact, splitting only above 50 items. Never collect planned work; omit unknown fields and free text.
