...
| `/bin/collect-activity.md` | `collectActivities` | Yes, canonical structured write | Employee and tenant ids bound by `AssistantService` | Record a bounded batch of separate structured employee activities; omit unknown values and accept no free text. |
