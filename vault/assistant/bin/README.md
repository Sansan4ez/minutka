...
| `/bin/read-recent-own-activities.md` | `readRecentOwnActivities` | No | Authenticated employee, company, and group | Return at most five own activities from the last 72 hours for an explicit correction lookup; closed facets plus opaque handle/revision, without identity fields or raw text. |
