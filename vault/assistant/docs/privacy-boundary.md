...
- The agent has no direct database, object-storage, shell, or arbitrary-file access. Reads use bounded projections; writes use typed application actions. External effects require explicit employee confirmation.
